...
if __name__ == '__main__':
    ...
    dataset = SdcSimDataset('/home/aakash01/Downloads/term1-simulator-linux/beta_simulator_linux/recording_data/')
    ...
    for epoch in range(5):  # loop over the dataset multiple times
        ...
        for i, (images, angles) in enumerate(dataloader):
            ...
            # code for forward pass, loss calc, back pass and optimizer step
            optimizer.zero_grad()
            outputs = net(images)
